...
struct dirent *dir_struct;//±£¥Ê∂¡»°ƒø¬ºµƒΩ·π˚
DIR* dir;//ƒø¬º¡˜
struct stat stat_buf;//”√¿¥¥Ê¥¢Œƒº˛ Ù–‘µƒΩ·ππÃÂ
if(path==NULL)path=argv[1];//path±Ì æ“™À—À˜µƒƒø¬º
char* filepath;//ƒø¬ºœ¬Œƒº˛µƒ¬∑æ∂
...
result[resultPosition++]=filepath;//Ω´≤È—ØΩ·π˚¥Ê¥¢µΩresult ˝◊È
 
}
else//»ÙÕ¨ ±¬˙◊„-name,-mtime,-ctime—°œÓ£¨«“√ª”–-exec—°œÓ‘Ú ‰≥ˆ
printf("%s\n",filepath);
...
continue;//»Ù∏√ƒø¬ºŒ™-prune—°œÓ÷∏∂®µƒƒø¬º£¨‘Ú≤ªΩ¯»Î∏√ƒø¬ºÀ—À˜
 
}
findFunc(argc,argv,filepath);//Ω¯»Î◊”ƒø¬ºÀ—À˜
